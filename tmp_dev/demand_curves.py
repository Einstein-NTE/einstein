...
def createDemandAndAvailabCurves():
    #global T, QDh, QAh, QDa, QAa #omitted TS 11/3/2008

    #define the temperature range for the hot (QD) and cold (QA) cureves 
    #T = range(0.0,405.0,5.0) # changed to 'frange' TS 11/3/2008
    ...
    return (T, QDh, QAh, QDa, QAa) # return the values in a tuple TS 11/3/2008
