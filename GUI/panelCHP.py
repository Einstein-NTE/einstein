...
#..............................................................................
# box1: table
        self.box1 = wx.StaticBox(self, -1, _("CHP equipment in the HC Supply System"),
...
# box2: figure
        ...
        self.box2 = wx.StaticBox(self, -1, _("Cumulative heat demand to be covered by CHP"),
...
#   action buttons
        ...
        self.CHPCalculate = wx.Button(id=wxID_PANELCHPCHPCALCULATE,
              label=_('run design assistant'), name='CHP_Calculate', parent=self,
        ...
        self.buttonpageCHPAdd = wx.Button(id=wxID_PANELCHPBUTTONPAGECHPADD,
              label=_('add CHP system'), name='buttonpageCHPAdd', parent=self,
...
# 1. Maintain existing equipment ?
        ...
        self.st3pageCHP = wx.StaticText(id=-1,
              label=_('Maintain existing equipment ?'), name='st3pageCHP',
...
# 2. CHP Type
        ...
        self.stConfig2 = wx.StaticText(id=-1, label=_('CHP System Type'),
...
# 3. Choose fuel
        ...
        self.stConfig3 = wx.StaticText(id=-1, label=_('Fuel Type'),
...
# 5. minimum operation hours
        ...
        self.stConfig4 = wx.StaticText(id=-1,
              label=_('Minimum operating hours'),
...
# 5. minimum effective electrical efficiency
        ...
        self.stConfig5 = wx.StaticText(id=-1, label=_('Min. electrical efficiency (ef.) [%]'),
...
# box 4     Info field
        ...
        self.stInfo1 = wx.StaticText(id=wxID_PANELCHPSTINFO1,
              label=_('CHP Operating hours'), name='stInfo1', parent=self,
        ...
        self.stInfo2 = wx.StaticText(id=wxID_PANELCHPSTINFO2,
              label=_('Effective electrical efficiency'), name='stInfo2',
        ...
        self.stInfo2b = wx.StaticText(id=-1, label=_('Demand at min. op. hours [kW]'),
              name='stInfo2b', parent=self, pos=wx.Point(616, 392), style=0)

        self.stInfo2_T1 = wx.StaticText(id=wxID_PANELCHPSTINFO2_T1, label=_('T< 80'),
              name='stInfo2_T1', parent=self, pos=wx.Point(504, 416), style=0)

        self.stInfo2_T2 = wx.StaticText(id=wxID_PANELCHPSTINFO2_T2, label=_('T<140'),
              name='stInfo2_T2', parent=self, pos=wx.Point(504, 440), style=0)

        self.stInfo2_T3 = wx.StaticText(id=wxID_PANELCHPSTINFO2_T3, label=_('T<250'),
              name='staticText3', parent=self, pos=wx.Point(504, 464), style=0)

        self.stInfo2_T4 = wx.StaticText(id=wxID_PANELCHPSTINFO2_T4, label=_('Total'),
              name='staticText4', parent=self, pos=wx.Point(504, 488), style=0)

        self.stInfo2_P1 = wx.StaticText(id=wxID_PANELCHPSTINFO2_P1, label=_('0'),
              name='stInfo2_P1', parent=self, pos=wx.Point(616, 416), style=0)

        self.stInfo2_P2 = wx.StaticText(id=wxID_PANELCHPSTINFO2_P2, label=_('0'),
              name='stInfo2_P2', parent=self, pos=wx.Point(616, 440), style=0)

        self.stInfo2_P3 = wx.StaticText(id=wxID_PANELCHPSTINFO2_P3, label=_('0'),
              name='stInfo2_P3', parent=self, pos=wx.Point(616, 464), style=0)

        self.stInfo2_P4 = wx.StaticText(id=wxID_PANELCHPSTINFO2_P4, label=_('0'),
...
#------------------------------------------------------------------------------		
        self.buttonpageCHPOk = wx.Button(id=wx.ID_OK, label=_('OK'),
        ...
        self.buttonpageCHPCancel = wx.Button(id=wx.ID_CANCEL, label=_('Cancel'),
...
#            self.choiceConfig4.SetSelection(TYPELIST.index(self.config[1]))
            ...
            print _("PanelCHP (display): was asked to display an erroneous fuel type"),self.config[1]
            pass
...
#            self.choiceConfig4.SetSelection(TYPELIST.index(self.config[1]))
            ...
            print _("PanelCHP (display): was asked to display an erroneous fuel type"),self.config[2]
            pass
...
# In interactive mode open DB Edidor Heat pump and select manually
        ...
        if (mode == "MANUAL"):
            self.dbe = DBEditFrame(self,
                            _('Select CHP equipment from preselected list'), # title for the dialogs
...
#------------------------------------------------------------------------------		
	...
	self.equipe = self.mod.addEquipmentDummy() #SD change 30/04/2008, delete equipeC
        ...
        if pu1.ShowModal() == wx.ID_OK:
            print _('PanelCHP AddEquipment accepted. Id=')+str(pu1.theId)
        else:
...
#------------------------------------------------------------------------------		
    def OnCbConfig1Checkbox(self, event):
        ...
        print _("PanelCHP: new config[%s] value: ")%0,self.config[0]
    ...
    def OnChoiceConfig2Choice(self, event):
        ...
        print _("PanelCHP: new config[%s] value: ")%3,self.config[1]
