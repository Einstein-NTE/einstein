...
#	Last revised by:    Tom Sobota                         12/03/2008
#
#       Change list:
...
#TS2008-03-21 panelEA1-EA6, EM1 added
...
#------------------------------------------------------------------------------		
    ...
    def OnTreeSelChanged(self, event):
        ...
        #qStatisticYPage1 'Primary energy - Yearly'
            ...
            self.hidePages()
            #self.pageStatisticPages.Show()
            #self.panelEA1 = PanelEA1(parent=self.leftpanel2, id=-1,
            #                         pos=wx.Point(0, 0), size=wx.Size(800, 600),
            #                         style=wx.TAB_TRAVERSAL, name='pageEA1')
            self.panelEA1.Show()
...
if __name__ == '__main__':
    ...
    Status.PId=1 # just for testing!
    Status.ANo=1

    app = wx.PySimpleApp()
    frame = EinsteinFrame(parent=None, id=-1, title="Einstein")
    #interf = Interfaces()
    #interf.chargeCurvesQDQA()
    #interf = None
    frame.Show(True)
    app.MainLoop()
