...
#       30/09/2008: SD  graphics figure added, changed units - line 340
...
[wxID_PANELBM3, wxID_PANELBM3BUTTONPAGEBM3BACK, 
 ...
 wxID_PANELBM3BUTTONPAGEBM3OK, wxID_PANELBM3COMBOSEARCHCRIT1, 
 wxID_PANELBM3FINDBENCHMARKS, wxID_PANELBM3GRIDPAGE, wxID_PANELBM3FIG, 
 wxID_PANELBM3SEARCHCRIT2, wxID_PANELBM3ST1, wxID_PANELBM3ST1PAGEBM3, 
 wxID_PANELBM3ST2, wxID_PANELBM3ST3PAGEBM3, wxID_PANELBM3STATICTEXT1, 
 wxID_PANELBM3STSEARCHCRIT1, wxID_PANELBM3STSEARCHCRIT2UNIT, 
 wxID_PANELBM3STSEARCHCRIT3, wxID_PANELBM3STTITLEPAGE, 
 wxID_PANELBM3TCSEARCHCRIT2A, wxID_PANELBM3TCSEARCHCRIT2B, 
 wxID_PANELBM3TCSEARCHCRIT3A, wxID_PANELBM3TCSEARCHCRIT3B, 
...
#------------------------------------------------------------------------------		
    ...
    print "PanelBM3 (drawFigure): NBenchmarks = ",NBenchmarks
...
#------------------------------------------------------------------------------		
	...
	keys = ['BM3']
        ...
        gdata = Status.int.GData["BM Info"]
        self.naceSearch =   gdata[0]
        self.naceSelector = gdata[1]
        self.turnover0 =    gdata[2]
        self.turnover1 =    gdata[3]
        self.year0 =        gdata[4]
        self.year1 =        gdata[5]

        self.processes =    gdata[7]
        self.unitOps =      gdata[8]
        self.selector =     gdata[9]
...
# box 1: grid display
        ...
        self.box1 = wx.StaticBox(self, -1, _U('Benchmark (3): specific energy consumption (SEC) by unit operation'),
                                 pos = (10,10),size=(780,260))
        self.box1.SetForegroundColour(TITLE_COLOR)
        self.box1.SetFont(wx.Font(8, wx.SWISS, wx.NORMAL, wx.BOLD))

        self.stProcess = wx.StaticText(id=-1,
              label=_U('Process:'), name='stProcess', parent=self, pos=wx.Point(10,
              280), size=wx.Size(80, 24), style=0)

        self.comboProcess = wx.ComboBox(choices=self.processes,
              id=-1, name='comboProcess', parent=self,
              pos=wx.Point(100, 280), size=wx.Size(140, 24), style=0)
#        self.comboProcess.SetSelection(0)
        self.comboProcess.Bind(wx.EVT_COMBOBOX, self.OnComboProcessChoice,id=-1)

        self.stUnitOp = wx.StaticText(id=-1,
              label="", name='stUnitOp', parent=self, pos=wx.Point(260,
              280), size=wx.Size(140, 24), style=0)

        self.gridPage = wx.grid.Grid(id=wxID_PANELBM3GRIDPAGE,
              name='gridpageBM3', parent=self, pos=wx.Point(20, 40),
...
# box 2: copmarison benchmarks
        ...
        self.panelFig = wx.Panel(id=wxID_PANELBM3FIG, name='panelAFigure',
...
# box 3: search criteria
        ...
        self.comboSearchCrit1 = wx.ComboBox(choices=self.naceSelector, id=wxID_PANELBM3COMBOSEARCHCRIT1,
...
# default action buttons
        ...
        self.buttonpageBM3Ok = wx.Button(id=wx.ID_OK, label=_U('OK'),
        ...
        self.buttonpageBM3Cancel = wx.Button(id=wx.ID_CANCEL, label=_U('Cancel'),
...
#------------------------------------------------------------------------------		
        ...
        process = self.comboProcess.GetValue()
        selector = self.comboProcess.GetSelection()
        self.stUnitOp.SetLabel(self.unitOps[selector])
        
        searchCriteria = [naceSearch,None,turnover0,turnover1,year0,year1,None,process,None,selector]
        Status.int.setGraphicsData("BM Info",searchCriteria)
        self.mod.updateSearch()
        self.display()
    
#------------------------------------------------------------------------------		
    def OnComboProcessChoice(self, event):
#------------------------------------------------------------------------------		
        print "PanelBM3: ComboBox event handler active !!!"
