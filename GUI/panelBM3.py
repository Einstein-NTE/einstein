...
#              False, 'Tahoma'))
        ...
        self.stUnitOp = wx.StaticText(id=-1,
              label=self.unitOps[0], name='stUnitOp', parent=self, pos=wx.Point(260,
...
#   create data table
        ...
        data = Status.int.GData["BM3 Table"]
...
#------------------------------------------------------------------------------		
        ...
        searchCriteria = [naceSearch,None,turnover0,turnover1,year0,year1,None,process,selector]
