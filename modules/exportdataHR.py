...
#
#    Todo: Schedules
#          replace db-connection with einstein default
#
#==============================================================================
#  Usage:
...
class XMLDocHRModuleBase:
    ...
    def handleSpecialCases(self,value,tag):
        ...
        realValueList = ["SupplyMedFlow","PTInMax","Area","Qhx","HPerYearHx","FlowSource","FlowSink","OmFix","OmVar","StorageSize","StreamStatusSource","StreamStatusSink","TurnKeyPrice"] ## TODO: fill list
        if (value==None):
...
class XMLExportHRModule:
    def export(path,qid,ano,export_exheatex = False):
        print "Exporting data to "+str(path)
