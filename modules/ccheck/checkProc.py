...
########## here change priority of parameters that are not needed

###        if iszero(DistribCircFlow):
###            self.Tin.priority = 99
...
#### sense of the if: -> if the value is not needed, because massflow = 0, then priority should remain 99 = not needed
            ...
            if self.PTInFlow.priority < 99: self.PTInFlow.priority = 3
